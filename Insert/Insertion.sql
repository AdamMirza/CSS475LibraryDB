...
(5555666011, 'Conan Edogawa', '2000-09-10', 'M', '44 Shirley Ave.  ', 'West Chicago', 'IL', 60185, 111311313, '2064223601', '15.00', 'Public Services Librarian', 1),
(6667771231, 'Ran Mouri', '1995-08-10', 'F', '70 Bowman St. ', 'South Windsor', 'CT', 60745, 897687564, '2067886598', '21.50', 'Library Assistant Manager', 2),
(6667771241, 'Kogoro Mouri', '1976-01-09', 'F', '70 Bowman St. ', 'South Windsor', 'CT', 60745, 897617162, '2067181198', '25.00', 'Circulation Supervisor', 2);

-- Dumping data for table 'RATE'
INSERT INTO `RATE` (`Media_type`, `Late_fee_rate`) VALUES
('Book', '2.50'),
('DVD', '1.50');
